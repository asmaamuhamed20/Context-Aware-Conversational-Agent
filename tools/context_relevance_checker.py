...
def build_context_relevance_tool(llm: BaseLanguageModel) -> Tool:
    ...
    tool = Tool.from_function(
        ...
        description="Use this tool after 'ContextPresenceJudge' outputs 'context_provided'. It checks if the provided context is actually relevant to the user's question. Input is the user's full message."
    )
    return tool